...
def run_copy_blocks(
    ...
    cache_cuda.copy_blocks(key_caches, value_caches, block_mapping)
...
def run_reshape_and_cache(
    ...
    cache_cuda.reshape_and_cache(key, value, key_cache, value_cache, slot_mapping)
...
def run_gather_cached_kv(
    ...
    cache_cuda.gather_cached_kv(key, value, key_cache, value_cache, slot_mapping)
